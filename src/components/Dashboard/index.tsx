...
const StyledAutocomplete:FC<WithTheme> = styled(Autocomplete)`
  ...
  .MuiOutlinedInput-notchedOutline{
    border-color: ${(props:WithTheme) => props.theme.palette.primary.contrastText};
  }
  .MuiInput-underline:before{
    border-color: ${(props:WithTheme) => props.theme.palette.primary.contrastText};
  }
  .MuiInput-underline:hover:not(.Mui-disabled):before{
    border-bottom-color: ${(props:WithTheme) => props.theme.palette.primary.contrastText};
  }
`
                ...
                <Toolbar className={classes.toolbar}>
                    ...
                    <StyledAutocomplete
                        ...
                        renderInput={(params:any) => (
                            <TextField {...params} label={intl.formatMessage(messages.language)} fullWidth />
                        )}
                    />
